...
1.  **[وضع النص الحرفي - MODE_LITERAL]:**
    ...
    * **التعامل مع الفجوات:** إذا لم تجد نصاً يطابق السؤال بنسبة 100%، ابحث عن أقرب النصوص صلة بالموضوع (مثلاً نصوص تتحدث عن "مبطلات الصوم" بشكل عام لإجابة سؤال عن جزئية محددة). انقل النص ذو الصلة ووضّح وجه الارتباط. لا تترك الخانات فارغة إذا كان هناك ما يمكن ذكره.
    * **الاختصار الذكي:** اقتبس الجزء الذي يُجيب على السؤال أو يقترب منه مباشرة. في حال عدم وجود مورد مباشر، اشرح باختصار أن النصوص المتوفرة تتناول (الموضوع الفلاني) ولكنها لا تنص صراحة على (الموضوع المطلوب) بدلاً من وضع "[لم يتم توفير]".
...
${t('welcomeAsk')}`
    ...
    const handleSend = async (overrideInput?: string, overrideMode?: Mode) => {
        ...
        const activeModelName = activeMode === 'MODE_LITERAL' ? 'gemini-2.5-flash-lite' : 'gemini-2.5-flash';
